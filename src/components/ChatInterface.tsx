                ...
                {!isInChat ? (
                    ...
                    <div className="hero-landing">
                        ...
                        <div className="hero-input-wrapper">
                            ...
                            <div className="hero-actions-row reveal-up">
                                <button className="hero-action-chip">
                                ...
                                <button className="hero-action-chip">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '8px' }}><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                                    DebEx
                                </button>
                                <button className="hero-action-chip">
